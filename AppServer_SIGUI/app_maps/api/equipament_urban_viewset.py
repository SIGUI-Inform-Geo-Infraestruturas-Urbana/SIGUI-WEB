...
class EquipamentUrbanViewSet(viewsets.ModelViewSet):
    ...
    def retrieve(self, request, *args, **kwargs):
       params = kwargs 
       print( params['pk'])
       objects = models.EquipamentCounty.objects.filter(id=params['pk']) 
       serializer = EquipamentCountySerializer(objects, many= True)
    ...
    def create(self, request, *args, **kwargs):
        try:
            ...
            write_serializer = EquipamentCountySerializer(data=espatial_request)
