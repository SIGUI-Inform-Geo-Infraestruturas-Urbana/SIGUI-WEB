...
@Component({
  selector: 'app-select-unit-linestring',
  templateUrl: './select-unit-linestring.component.html',
  styleUrls: ['./select-unit-linestring.component.css']
})
export class SelectLineStringComponent implements OnInit {
