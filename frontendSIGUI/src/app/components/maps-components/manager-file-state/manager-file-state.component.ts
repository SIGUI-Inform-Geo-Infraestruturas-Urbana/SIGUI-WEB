...
@Component({
  selector: 'app-manager-file-state',
  templateUrl: './manager-file-state.component.html',
  styleUrls: ['./manager-file-state.component.css']
})
export class ManagerFileStateComponent implements OnInit {
  fileName = ''; 
