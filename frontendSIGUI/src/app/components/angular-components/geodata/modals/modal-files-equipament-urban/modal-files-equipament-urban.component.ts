...
@Component({
  selector: 'app-modal-files-equipament-urban',
  templateUrl: './modal-files-equipament-urban.component.html',
  styleUrls: ['./modal-files-equipament-urban.component.css']
})
export class ModalFilesEquipamentUrbanComponent{
  ...
  constructor(public restApi: ShapefilesRepositoryService, private snackBar : MatSnackBar,
    public dialogRef: MatDialogRef<ModalFilesEquipamentUrbanComponent>,
  ...
  onFileSelected(event:any):void{
   ...
   // console.log(selectedFiles.length)
    ...
    let filesSelect = new FileData('equipament');
  ...
  preparFiles(files:FileData){
    ...
    formData.append('category','equipament')
  ...
  getFile():void{
    ...
    this.restApi.findFetchParam('equipament').subscribe({
