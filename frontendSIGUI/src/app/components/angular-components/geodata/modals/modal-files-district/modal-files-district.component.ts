...
@Component({
  selector: 'app-modal-files-district',
  templateUrl: './modal-files-district.component.html',
  styleUrls: ['./modal-files-district.component.css']
})
export class ModalFilesDistrictComponent  {
  ...
  constructor(public restApi: ShapefilesRepositoryService, private snackBar : MatSnackBar,
    public dialogRef: MatDialogRef<ModalFilesDistrictComponent>,
  ...
  onFileSelected(event:any):void{
   ...
   // console.log(selectedFiles.length)
    ...
    let filesSelect = new FileData('district');
  ...
  preparFiles(files:FileData){
    ...
    formData.append('category','district')
  ...
  getFile():void{
    ...
    this.restApi.findFetchParam('district').subscribe({
